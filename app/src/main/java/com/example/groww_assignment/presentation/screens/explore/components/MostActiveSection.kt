...
fun MostActiveSection(
    ...
    Column(modifier = modifier.fillMaxWidth()) {
        SectionHeader(
            title = "Most Active",
            subtitle = "High volume trading stocks",
        ...
        if (stocks.isEmpty()) {
            EmptyState(
                title = "No Active Stocks Data",
                message = "Most active stocks information is not available right now",
            ...
            LazyRow(
                ...
                items(
                    ...
                    StockCard(
                        ...
                        showVolume = true // Emphasize volume for most active
                    )
                }
            }
        }
